...
type Product = { id: string; sku: string; slug: string; name: string; product_type: ProductType; price_vnd: number; sale_price_vnd: number | null; description: string; composition: string | null; featured: boolean; status: Status; archived_at: string | null; product_images: ImageItem[]; product_categories: Relation[]; product_tones: Relation[]; product_occasions: Relation[] };
type Taxonomy = { id: string; name: string; slug: string; is_active: boolean };
type FormState = { sku: string; slug: string; name: string; productType: ProductType; priceVnd: string; salePriceVnd: string; description: string; composition: string; featured: boolean; status: Status; categoryIds: string[]; toneIds: string[]; occasionIds: string[] };

const blank: FormState = { sku: "", slug: "", name: "", productType: "bouquet", priceVnd: "", salePriceVnd: "", description: "", composition: "", featured: false, status: "draft", categoryIds: [], toneIds: [], occasionIds: [] };
...
export default function AdminProductsPage() {
  ...
  async function saveProduct(event: FormEvent) {
    ...
    const payload = { ...form, priceVnd: Number(form.priceVnd), salePriceVnd: form.salePriceVnd ? Number(form.salePriceVnd) : null };
    ...
    await loadProducts(id); setSelected((current) => current || result.product); setShowEditor(true);
  }
