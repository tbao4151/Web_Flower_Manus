    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container-cas grid gap-8 py-8 sm:py-12 md:grid-cols-[minmax(0,1.08fr)_minmax(360px,.92fr)] md:items-start">
        ...
        <article className="rounded-[28px] border border-border bg-surface p-6 sm:p-9">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-2"><Link href={`/?add=${product.slug}`} className="press flex min-h-12 items-center justify-center gap-2 rounded-full bg-primary font-bold text-white"><ShoppingBag size={17} /> Thêm vào giỏ</Link><Link href="/tra-cuu-don-hang" className="press flex min-h-12 items-center justify-center rounded-full border border-border font-bold">Tra cứu đơn</Link></div>
